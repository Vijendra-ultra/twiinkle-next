...
const NavBarforAuthedUser: React.FC = () => {
  ...
  return (
    <div
      className={`flex  justify-start fixed backdrop-blur-0 bg-white/70 dark:bg-inherit border-b  border-white/30 dark:border-black/30  w-full top-0  items-center pl-3 md:px-6 pb-3 pt-1.5 md:pt-3 pr-5 md:pr-10 transition-all ease-in-out duration-600 `}
    >
      {" "}
